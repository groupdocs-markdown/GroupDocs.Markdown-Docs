...
* [Convert files]({{< ref "markdown/java/developer-guide/basic-usage/convert/" >}}) -- convert PDF, Word, Excel, EPUB, and text documents to Markdown.
* [Get document info]({{< ref "markdown/java/developer-guide/basic-usage/get-document-info" >}}) -- retrieve document metadata such as format, page count, title, and author without performing a full conversion.
